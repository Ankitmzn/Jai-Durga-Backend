pipeline {
    ...
    environment {
        ...
        UPLOAD_DIR = 'D:\Weblogic\Oracle\Middleware\Oracle_Home\user_projects\domains\base_domain\servers\new_ManagedServer_1\stage' // Directory for uploading WAR file
